...
The Xtream movie page caps the combined local and cross-portal result at nine
cards. Its desktop presentation is a three-column grid (two columns below
700 px and one below 420 px), avoiding a mouse-wheel-hostile horizontal rail.
